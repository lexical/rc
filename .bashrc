...
alias giso="oem-getiso --method=zsync --auth_token=\`get-oemshare-auth-token\`"

export EDITOR=vim
export DEBFULLNAME="Keng-Yu Lin"
export DEBEMAIL="kengyu@hpe.com"
...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;33m\]\u@\H:\[\033[01;34m\]\w\[\033[00m\] `git branch 2> /dev/null | grep -e ^* | sed -E  s/^\\\\\*\ \(.+\)$/\\\\\\1\\ /`\$ '
else
